...
export const Disclaimer = () => (
  <>
    ...
    <div className="p-12">
      ...
      <p className="p-3">
        {" "}
        The place name boundaries that make up Kauaʻi Nui Kuapapa correspond to
        several 18th and 19th century survey maps. The intent of this project is
        ...
        Territory of Hawai‘i (1893 onwards), as opposed to the data sets
        regarding the same land areas that derive from the State of Hawai‘i or
        USGS, which describe present-day land areas. The orthography of place
        names was researched by this project's contributors from a variety of
        sources that can be found in the "Resources" section of this website.
        With regard to place names whose meanings are uncertain, the best
        educated guess was the basis for orthography. Note that the following
        symbols were appended to ahupua‘a names in cases where correct spellings
        for place names are in question: - pronunciation and meaning are
        uncertain - not found in any existing database, archive, written or
        published in any record regarding place names of Hawaiʻi
      </p>
      <p className="p-3">
