    ...
    <div className="disclaimer">
      <div className="disclaimer-text p-10">
        ...
        <p className="p-3">
          ...
          project is to represent three (3) periods in time with respect to moku
          and ahupua‘a borders—those time periods being the era of the reign of
          King Kaumuali‘i (circa 1778 to 1824), the Kingdom of Kamehameha (1810
          to 1893), and the Territory of Hawai‘i (1893 onwards), as opposed to
          the data sets regarding the same land areas that derive from the State
          of Hawai‘i or USGS, which describe present-day land areas. The
          orthography of place names was researched by this project's
          contributors from a variety of sources that can be found in the
          "Resources" section of this website. With regard to place names whose
          ...
          names in cases where correct spellings for place names are in
        ...
        <p className="p-3">
          ...
          warranty is made regarding the positional or thematic accuracy of the
          GIS data. The GIS data and any features it depicts do not represent or
          confer any legal rights, privileges, benefits, boundaries or claims of
          any kind and have no implication for real estate, tax or political
