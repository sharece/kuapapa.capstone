export const Bio = () => (
  <div>
    ...
    <p>
      Definition from Pukui/Elbert Hawaiian Dictionary, Copyright 1986. land
      division, usually extending from the uplands to the sea, so called because
      the boundary was marked by a heap (ahu) of stones surmounted by an image
      of a pig (pua'a), or because a pig or other tribute was laid on the alter
      as tax to the chief.
    </p>
  </div>
