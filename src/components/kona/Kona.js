...
import konamap from "../../assets/ahu-divisions/konamap.png";
import konasign from "../../assets/ahu-signs/konasign.png";
import mokupic from "../../assets/moku-imgs/konamokuimg.png";
    ...
    <div className="moku-container">
      ...
      <div className="moku-links-and-text">
        ...
        <div className="moku-text">
          ...
          Kaunalewa and numerous old mele (chants, songs) boasted about the
          beauty of this place. People across the islands knew of this grove
          through these mele, even those who had never visited the area. The
          sugar industry removed the grove to plant sugar, and so the coconut
          tree in this logo is a homage to Kaunalewa. The fish is pāpio, a
          common and well-loved fish among Kaua‘i fishermen and locals in
          general. The area between Polihale Beach Park and Nōhili Point is
          known as Pāpiohuli. This is the spot on the island that enjoys the
          last rays of sunlight at the end of each day, and so this fish was
          chosen to highlight Kona's position on the west end of Kaua‘i. The
          color association for Kona is red as the brightest red dirt of Waimea
          Canyon.
        </div>
      </div>
    </div>
