          ...
          <div className="ahu-row-1 flex">
            <div className="mobile-ahu-row">
              <Link className="ahu-link" to="/mana">
                {/* Mana */}
                <img src={mana} width="80%" alt="mana ahupuaa link" />
              </Link>{" "}
              <Link className="ahu-link" to="/waimea">
                {/* Waimea */}
                <img src={waimea} width="80%" alt="waimea ahupuaa link" />
              </Link>{" "}
            </div>
            <div className="mobile-ahu-row">
              <Link className="ahu-link" to="/makaweli">
                {/* Makaweli */}
                <img src={makaweli} width="80%" alt="makaweli ahupuaa link" />
              </Link>
              <Link className="ahu-link" to="/hanapepe">
                <img src={hanapepe} width="80%" alt="hanapepe ahupuaa link" />
                {/* Hanapepe */}
              </Link>{" "}
            </div>
          </div>
          <div className="ahu-row-2 flex">
            <div className="mobile-ahu-row">
              <Link className="ahu-link" to="/wahiawa">
                <img src={wahiawa} width="80%" alt="wahiawa ahupuaa link" />
                {/* Wahiawa */}
              </Link>{" "}
              <Link className="ahu-link" to="/kalaheo">
                <img src={kalaheo} width="80%" alt="kalaheo ahupuaa link" />
                {/* Kalaheo */}
              </Link>
            </div>
            <div className="mobile-ahu-row">
              <Link className="ahu-link" to="/lawai">
                <img src={lawai} width="80%" alt="lawai ahupuaa link" />
                {/* Lawai */}
              </Link>{" "}
              <Link className="ahu-link" to="/koloa">
                {/* Koloa */}
                <img src={koloa} width="80%" alt="koloa ahupuaa link" />
              </Link>
            </div>
          </div>
          <div className="ahu-row-3 flex">
            <div className="mobile-ahu-row">
              <Link className="ahu-link" to="/weliweli">
                {/* Weli weli */}
                <img src={weliweli} width="80%" alt="weliweli ahupuaa link" />
              </Link>
              <Link className="ahu-link" to="/paa">
                {/* Pa'a */}
                <img src={paa} width="80%" alt="paa ahupuaa link" />
              </Link>
            </div>
            <div className="mobile-ahu-row">
              <Link className="ahu-link" to="/mahaulepu">
                {/* Mahaulepu */}
                <img src={mahaulepu} width="80%" alt="mahaulepu ahupuaa link" />
              </Link>
            </div>
          </div>
        </div>
